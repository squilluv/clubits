...
var ThemeSwitcher = /** @class */ (function (_super) {
    __extends$1(ThemeSwitcher, _super);
...
var _x2 = _interopRequireDefault(x);
...
var Toggle = unwrapExports(component);
...
var Moon = function () { return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", color: "white", style: { height: '14px', marginTop: '-2px' } },
    React.createElement("path", { fill: "currentColor", d: "M283.211 512c78.962 0 151.079-35.925 198.857-94.792 7.068-8.708-.639-21.43-11.562-19.35-124.203 23.654-238.262-71.576-238.262-196.954 0-72.222 38.662-138.635 101.498-174.394 9.686-5.512 7.25-20.197-3.756-22.23A258.156 258.156 0 0 0 283.211 0c-141.309 0-256 114.511-256 256 0 141.309 114.511 256 256 256z" }))); };
var Sun = function () { return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", color: "white", style: { height: '14px', marginTop: '-2px' } },
...
var verifyTheme = function (dark, light) {
    var darkKeys = Object.keys(dark);
    var lightKeys = Object.keys(light);
    var darkSaturated = Object.keys(dark).every(function (value) {
        var index = lightKeys.indexOf(value);
        if (index >= 0) {
    ...
    var lightSaturated = Object.keys(light).every(function (value) {
        var index = darkKeys.indexOf(value);
        if (index >= 0) {
    ...
    if (!darkSaturated || !lightSaturated) {
        var lightError = lightKeys.length ? lightKeys.join(' \n') : 'None';
        var darkError = darkKeys.length ? darkKeys.join(' \n') : 'None';
        throw new Error("Theme not saturated. Variables missing in light theme: " + lightError + ". Variables missing in dark theme: " + darkError);
    }
};
/**
 ...
 * @param light
 */
function createTheme(dark, light) {
...
var DarkTheme = /** @class */ (function (_super) {
    ...
    function DarkTheme(props) {
        ...
        _this.handleToggleChange = function () {
            _this.setState(function (prevState) { return ({ dark: !prevState.dark }); });
        };
    ...
    DarkTheme.prototype.render = function () {
        return (React.createElement(React.Fragment, null,
            React.createElement(ThemeSwitcher, { theme: this.state.dark ? this.props.dark : this.props.light }),
            React.createElement(Toggle, { className: this.props.className, checked: this.state.dark, onChange: this.handleToggleChange, icons: {
                    checked: React.createElement(Moon, null),
                    unchecked: React.createElement(Sun, null),
                } })));
    };
    DarkTheme.propTypes = {
