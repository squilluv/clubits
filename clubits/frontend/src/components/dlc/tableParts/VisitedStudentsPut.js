            ...
            <Fragment>
                {this.state.showRes == "1" ? <div className="text-left">
                    <h3><a className="primary-color" onClick={() => { this.setState({ showRes: "0" }); this.onClick }}>Cкрыть</a></h3>
                        ...
                        <h3><a className="primary-color" onClick={() => { this.setState({ showRes: "1", checkOper: "0", student: "", have: "0", visited: this.props.courseId }); this.onClick }}>Добавить</a></h3>
                    </div>
                }
                {
                            ...
                            <tr key={usr.id}>
                                ...
                                <td><Fragment>
                                    <a
                                        ...
                                        onClick={() => { this.setState({ id: usr.id, student: usr.student, have: usr.have, checkOper: "1", showRes: "1", visited: this.props.courseId }); this.onClick }}
                                    >PUT</a>
                                </Fragment></td>
                                <th><a
