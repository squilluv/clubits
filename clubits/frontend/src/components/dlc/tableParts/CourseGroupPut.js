...
export class CourseGroupPut extends Component {
    ...
    onClick = (sid, sname, param) => {
        if (param == "1") {
            ...
            this.setState({ id: sname, name: sid, checkOper: "1", showRes: "1" })
        }
        this.setState({ course: this.props.courseId })
    }
            ...
            <Fragment>
                {this.state.showRes == "1" ? <div className="text-left">
                    <h3><a className="primary-color" onClick={() => { this.setState({ showRes: "0" }); this.onClick }}>Cкрыть</a></h3>
                        ...
                        <h3><a className="primary-color" onClick={() => { this.setState({ showRes: "1", checkOper: "0", name: "", course: this.props.courseId }); this.onClick }}>Добавить</a></h3>
                    </div>}
                            ...
                            <tr key={usr.id}>
                                ...
                                <td><Fragment>
                                    <a
                                        ...
                                        onClick={() => { this.setState({ id: usr.id, name: usr.name, checkOper: "1", showRes: "1", course: this.props.courseId }); this.onClick }}
                                    >PUT</a>
                                </Fragment></td>
                                <th><a
...
export default connect(mapStateToProps, { getCoursgroup, addCoursgroup, putCoursgroup, deleteCoursgroup })(CourseGroupPut)